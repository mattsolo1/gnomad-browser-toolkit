...
const parseSelectedNodeIds = (selected: string[]) => {
  ...
  console.log('uniqClassifications', uniqClassifications)
  console.log('hierarchicalCategories', hierarchicalCategories)
  console.log('simpleCategories', simpleCategories)
  return {
    uniqClassifications,
